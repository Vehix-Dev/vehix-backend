...
# 🌍 SHARED CACHE: This ensures Gunicorn and Daphne share heartbeats!
CACHES = {
    "default": {
...
DATABASES = {
    'default': {
        ...
        'NAME': config('POSTGRES_DB', default='parkingdb'),
        'USER': config('POSTGRES_USER', default='parkinguser'),
...
STATICFILES_STORAGE = 'config.storage.FallbackManifestStaticFilesStorage'
